import { ClaimCase, InsurerInfo, StaffMember, DepreciationConfig, ThresholdProfile, CompanyRegistrationRequest } from '../types';
...
export const INSURER_COMPANIES: InsurerInfo[] = [
  {
    ...
    economicCode: '411389472911',
    registrationNumber: '19482',
    adminName: 'دکتر علیرضا ابراهیمی',
    adminNationalId: '0054812390',
    adminPhone: '09121112233',
    adminEmail: 'ebrahimi@dana-insurance.ir',
    phone: '۰۲۱-۸۸۷۷۶۶۵۵',
  ...
  },
  {
    ...
    economicCode: '411119283741',
    registrationNumber: '1001',
    adminName: 'مهندس محمدرضا شریفی',
    adminNationalId: '0067341902',
    adminPhone: '09122223344',
    adminEmail: 'sharifi@iraninsurance.ir',
    phone: '۰۲۱-۸۶۷۲۱۰۰۰',
  ...
  },
  {
    ...
    economicCode: '411294817263',
    registrationNumber: '6743',
    adminName: 'دکتر فرشاد کاظمی',
    adminNationalId: '0078923415',
    adminPhone: '09123334455',
    adminEmail: 'kazemi@alborzinsurance.ir',
    phone: '۰۲۱-۸۸۷۳۲۱۱۰',
  ...
  },
  {
    ...
    economicCode: '411382910492',
    registrationNumber: '5420',
    adminName: 'مهندس بهزاد نادری',
    adminNationalId: '0041289304',
    adminPhone: '09124445566',
    adminEmail: 'naderi@asiainsurance.ir',
    phone: '۰۲۱-۸۸۸۰۰۲۰۰',
  ...
  },
  {
    ...
    economicCode: '411983021948',
    registrationNumber: '21123',
    adminName: 'دکتر آرش مظفری',
    adminNationalId: '0081928471',
    adminPhone: '09125556677',
    adminEmail: 'mozaffari@melatinsurance.com',
    phone: '۰۲۱-۸۵۳۳۳',
...
export const INITIAL_CASES: ClaimCase[] = [
  ...
  // ----------------------------------------------------
  {
    ...
    assessment: {
      totalPartsPrice: 75000000,
      totalWagePrice: 25000000,
      totalDepreciation: 0,
    ...
    diminutionValue: 35000000,
    diminutionPercent: 12,
    culpritDebtAmount: 80000000,
    assignedExpert: {
      id: 'd1',
      name: 'محسن کریمی',
    ...
    history: [
      ...
      {
        status: 'ارزیابی و تعیین مازاد بدهی مقصر',
        time: '۱۴۰۳/۰۵/۱۴ ۱۱:۰۰',
        user: 'محسن کریمی',
        userRole: 'ارزیاب خسارت',
        note: 'ارزیابی خسارت به مبلغ کل ۱۳۰,۰۰۰,۰۰۰ تومان تایید شد. ۵۰,۰۰۰,۰۰۰ تومان در سقف بیمه دانا و ۸۰,۰۰۰,۰۰۰ تومان مازاد بدهی مقصر (علیرضا حسینی).'
      }
    ]
  },
  {
    ...
    history: [
      {
        ...
        user: 'محسن کریمی',
        userRole: 'ارزیاب خسارت',
        note: 'برآورد خسارت به مبلغ ۴۲,۵۰۰,۰۰۰ تومان تایید گردید و جهت واریز به شماره شبا به خزانه‌داری ارجاع شد.'
      }
    ]
  },
  {
    id: 'CF-6190-IR',
    date: '۱۴۰۳/۰۵/۱۶ - ۱۴:۲۰',
    address: 'تهران، بزرگراه شهید چمران، نرسیده به پل مدیریت',
    victimName: 'سهراب رحیمی',
    victimNationalId: '0195341643',
    victimPhone: '09123339900',
    victimPlate: '۶۳ ج ۸۱۴ ایران ۴۴',
    victimInsurer: 'بیمه آسیا',
    culpritName: 'مهدی کشاورز',
    culpritNationalId: '0207736170',
    culpritPhone: '09123456789',
    culpritPlate: '۴۵ ب ۶۷۸ ایران ۲۲',
    culpritInsurer: 'iran',
    insurerCode: 'iran',
    insurerName: 'بیمه ایران',
    carType: 'تارا اتوماتیک V4',
    culpritCarType: 'پژو ۲۰۶ تیپ ۵',
    plate: '۶۳ ج ۸۱۴ ایران ۴۴',
    culpritPolicyNo: 'IRN-1403-88120',
    culpritCoverageFinancial: 50000000,
    culpritFaultPercent: 100,
    partyOneName: 'مهدی کشاورز',
    partyOnePhone: '09123456789',
    partyOneRole: 'مقصر',
    partyTwoName: 'سهراب رحیمی',
    partyTwoPhone: '09123339900',
    partyTwoRole: 'زیان‌دیده',
    status: 'در انتظار پرداخت',
    priority: 'مهم',
    hasKroki: true,
    croquiType: 'electronic',
    assessment: {
      totalPartsPrice: 65000000,
      totalWagePrice: 20000000,
      totalDamage: 85000000,
      salvage: 5000000,
      payableAmount: 50000000,
      assessedBy: 'رضا تهرانی',
      status: 'PUBLISHED'
    },
    diminutionValue: 20000000,
    culpritDebtAmount: 50000000,
    iban: 'IR770120000000887766554433',
    ibanConfirmed: true,
    history: [
      {
        status: 'ارزیابی و محاسبه مازاد بدهی مقصر',
        time: '۱۴۰۳/۰۵/۱۶ ۱۵:۰۰',
        user: 'رضا تهرانی',
        userRole: 'ارزیاب خسارت',
        note: 'خسارت کل ۱۰۰,۰۰۰,۰۰۰ تومان برآورد شد. ۵۰,۰۰۰,۰۰۰ تومان از محل بیمه ایران و ۵۰,۰۰۰,۰۰۰ تومان بدهی مازاد مقصر (مهدی کشاورز) به زیان‌دیده.'
      }
    ]
  },
  {
...
export const INITIAL_COMPANY_REQUESTS: CompanyRegistrationRequest[] = [
  {
    id: 'REQ-1403-089',
    companyName: 'بیمه سرمد',
    companyCode: 'sarmad',
    economicCode: '411492019482',
    registrationNumber: '44819',
    licenseNumber: 'LIC-SRM-1392',
    sanhabCode: '26',
    insuranceLines: ['بیمه شخص ثالث خودرو', 'بیمه بدنه خودرو'],
    province: 'تهران',
    city: 'تهران',
    address: 'تهران، بلوار آفریقا، خیابان ارمغان غربی، پلاک ۲۳',
    companyPhone: '۰۲۱-۴۳۹۷۵۰۰۰',
    companyEmail: 'info@sarmadins.ir',
    adminName: 'دکتر مجید حبیبی',
    adminNationalId: '0098234156',
    adminPhone: '09127778899',
    adminEmail: 'habibi@sarmadins.ir',
    officialGazetteFile: 'https://images.unsplash.com/photo-1568667256549-094345857637?w=600&auto=format&fit=crop&q=80',
    officialGazetteFileName: 'rooznameh-rasmi-sarmad-1402.pdf',
    introLetterFile: 'https://images.unsplash.com/photo-1450133064473-71024230f91b?w=600&auto=format&fit=crop&q=80',
    introLetterFileName: 'moarrefi-nameh-modir-arshad.pdf',
    licenseDocFile: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&auto=format&fit=crop&q=80',
    licenseDocFileName: 'parvaneh-bimeh-markazi.pdf',
    submittedAt: '1403/05/18 10:30',
    status: 'PENDING'
  },
  {
    id: 'REQ-1403-088',
    companyName: 'بیمه ما',
    companyCode: 'ma',
    economicCode: '411894210948',
    registrationNumber: '40912',
    licenseNumber: 'LIC-MAA-1390',
    sanhabCode: '23',
    insuranceLines: ['بیمه شخص ثالث خودرو', 'بیمه بدنه خودرو'],
    province: 'تهران',
    city: 'تهران',
    address: 'تهران، خیابان ونک، خیابان خدامی، بن‌بست هومن، پلاک ۱',
    companyPhone: '۰۲۱-۸۶۹۰',
    companyEmail: 'support@bimehma.com',
    adminName: 'مهندس کامران رستمی',
    adminNationalId: '0061294812',
    adminPhone: '09128889900',
    adminEmail: 'rostami@bimehma.com',
    officialGazetteFile: 'https://images.unsplash.com/photo-1568667256549-094345857637?w=600&auto=format&fit=crop&q=80',
    officialGazetteFileName: 'agahi-tasis-bimeh-ma.pdf',
    introLetterFile: 'https://images.unsplash.com/photo-1450133064473-71024230f91b?w=600&auto=format&fit=crop&q=80',
    introLetterFileName: 'hokm-modiriat-rostami.pdf',
    licenseDocFile: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&auto=format&fit=crop&q=80',
    licenseDocFileName: 'bimeh-markazi-mojavaz.pdf',
    submittedAt: '1403/05/17 14:15',
    status: 'PENDING'
  },
  {
    id: 'REQ-1403-085',
    companyName: 'بیمه کوثر',
    companyCode: 'kowsar',
    economicCode: '411294810294',
    registrationNumber: '39481',
    licenseNumber: 'LIC-KWS-1389',
    sanhabCode: '24',
    insuranceLines: ['بیمه شخص ثالث خودرو', 'بیمه بدنه خودرو'],
    province: 'تهران',
    city: 'تهران',
    address: 'تهران، میدان ونک، بزرگراه حقانی، نبش خیابان شهیدی',
    companyPhone: '۰۲۱-۸۹۳۸۲',
    companyEmail: 'info@kins.ir',
    adminName: 'دکتر صابر حسنی',
    adminNationalId: '0059281723',
    adminPhone: '09129990011',
    adminEmail: 'hassani@kins.ir',
    officialGazetteFile: 'https://images.unsplash.com/photo-1568667256549-094345857637?w=600&auto=format&fit=crop&q=80',
    officialGazetteFileName: 'rooznameh-rasmi-kowsar.pdf',
    introLetterFile: 'https://images.unsplash.com/photo-1450133064473-71024230f91b?w=600&auto=format&fit=crop&q=80',
    introLetterFileName: 'moarrefi-nameh.pdf',
    submittedAt: '1403/05/10 09:00',
    status: 'APPROVED',
    reviewedAt: '1403/05/11 11:30',
    reviewedBy: 'مدیر کل پلتفرم (Super Admin)'
  }
];
