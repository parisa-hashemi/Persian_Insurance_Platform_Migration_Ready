      ...
      {authMode === 'REGISTER' && (
        <div className="flex items-center justify-between p-3 bg-blue-50/70 rounded-2xl border border-blue-100">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-xs font-black text-slate-900">ثبت‌نام جدید در سامانه</h3>
              <p className="text-[10px] text-slate-500 font-medium">اطلاعات هویتی خود را وارد نمایید</p>
            </div>
          </div>
          <button
            type="button"
            ...
            className="px-2.5 py-1.5 rounded-xl bg-white border border-slate-200 text-slate-700 hover:text-blue-700 text-xs font-bold transition flex items-center gap-1 cursor-pointer shadow-xs"
          >
        ...
        <div className="pt-4 border-t border-slate-200/80 text-center">
          <p className="text-xs text-slate-600 font-medium flex items-center justify-center gap-1.5">
            ...
            <button
              ...
              className="font-black text-blue-700 hover:text-blue-800 hover:underline cursor-pointer transition inline-flex items-center gap-1"
            >
              <UserPlus className="w-3.5 h-3.5" />
