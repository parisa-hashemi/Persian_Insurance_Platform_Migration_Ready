...
export const AIChatCopilotModal: React.FC<AIChatCopilotModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center p-3 sm:p-4 bg-slate-950/70 backdrop-blur-sm animate-in fade-in overflow-y-auto">
      <div className="bg-slate-900 text-white w-full max-w-2xl h-[85vh] sm:h-[620px] rounded-3xl border border-indigo-500/30 shadow-2xl flex flex-col overflow-hidden">
        {/* Modal Header */}
